...
router.post('/operations/join', auth.isAuthenticated, auth.hasRank(4), operationController.join);
router.post('/operations/leave', auth.isAuthenticated, auth.hasRank(4), operationController.leave);
