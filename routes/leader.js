...
router.get('/roles', auth.isAuthenticated, auth.hasRank(5), roleController.index);
router.get('/roles/create', auth.isAuthenticated, auth.hasRank(5), roleController.create);
router.post('/roles/create', auth.isAuthenticated, auth.hasRank(5), roleController.store);
router.get('/roles/:id', auth.isAuthenticated, auth.hasRank(5), roleController.show);
router.post('/roles/:id', auth.isAuthenticated, auth.hasRank(5), roleController.update);
router.get('/roles/:id/delete', auth.isAuthenticated, auth.hasRank(5), roleController.delete);
